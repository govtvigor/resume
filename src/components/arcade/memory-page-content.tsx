...
import { NebulaMatchLazy } from "@/components/arcade/game-loader";
  ...
  return (
    <>
      ...
      <main className="mx-auto flex min-h-[calc(100dvh-var(--site-header-h))] max-w-4xl flex-col gap-6 px-4 py-8 sm:gap-8 sm:px-5 sm:py-12 md:px-8">
        ...
        <HoloPanel title="Nebula Match" accent="lime" contentClassName="px-4 py-6 sm:px-6">
          <p className="text-sm text-lime-300/90">Cabinet 03 — Live</p>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight text-foreground sm:text-3xl 3xl:text-4xl">
            Nebula Match
          </h1>
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            Flip cards, match all eight constellations, and chase a faster run for
            bonus points.
          </p>
          <div className="mt-8">
            <NebulaMatchLazy />
